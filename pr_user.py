...
class User:
	...
	def __init__(self, first_name, last_name, gender, age, occupation, location, login_attempts=0):
		"""初始化用户的基本信息"""
	...
	def greet_user(self):
		"""向用户发出问候语。"""
		print(f"{self.first_name}{self.last_name}, 欢迎回来，希望你在{self.location}度过美好的时光。")
